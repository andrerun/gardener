...
| BilinearAutoscaling                | `false` | `Alpha` | `1.93` |        |
...
| BilinearAutoscaling               | `gardenlet`                       | When enabled, shoot kube-apiserver is scaled simultaneously via HPA on request rate and VPA on resource usage. When enabled, this feature takes prececence over the HVPA and HVPAForShootedSeed features in determining how shoot kube-apiserver pods are scaled.                                                                                                                  |

...
| PVCAutoscalingForObservabilityVolumes        | `false` | `Alpha`      | `1.107`   |         |
...
| PVCAutoscalingForObservabilityVolumes  | `gardenlet`                       | Enables capacity autoscaling for shoot and seed observability PVCs.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
